...
export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72-3.72a1.05 1.05 0 00-1.485 0l-3.72 3.72a2.123 2.123 0 01-3.18 0l-3.72-3.72a1.05 1.05 0 00-1.485 0l-1.5 1.5a.75.75 0 000 1.06l3.72 3.72a2.123 2.123 0 003.18 0l3.72-3.72a1.05 1.05 0 000-1.485l-1.5-1.5a.75.75 0 010-1.06l3.72-3.72a2.123 2.123 0 013.18 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.019 14.25h.014v.014h-.014v-.014z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.015 11.25h.015v.015h-.015v-.015z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.99 14.25h.015v.015h-.015v-.015z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.375c.621 0 1.125.504 1.125 1.125v4.286c0 1.136.847 2.1 1.98 2.193l3.72-3.72a1.05 1.05 0 00-1.485 0L8.25 12.188a.75.75 0 000 1.06l1.5 1.5a1.05 1.05 0 001.485 0l3.72-3.72a2.123 2.123 0 013.18 0l3.72 3.72a.75.75 0 001.06 0l1.5-1.5a1.05 1.05 0 000-1.485l-3.72-3.72a2.123 2.123 0 00-3.18 0L9.75 9.438a.75.75 0 01-1.06 0l-1.5-1.5a1.05 1.05 0 00-1.485 0L1.97 9.713A2.123 2.123 0 013.75 6.375z" />
    </svg>
);
